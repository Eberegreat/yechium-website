...
const Footer: React.FC = () => {
  const developerWhatsappUrl = "https://wa.me/2348067628656?text=Hello%20DigiBeloved,%20I%20saw%20the%20Yechium%20Wellness%20website%20and%20I'm%20interested%20in%20getting%20one%20for%20my%20business.";
    ...
    <footer className="bg-yellow-50 text-brand-dark">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-12 border-t border-brand-primary/20 pt-8 text-center text-sm text-brand-dark/60">
          <p>
            &copy; {new Date().getFullYear()} Yechium Wellness & Foods. All Rights Reserved.
            ...
            <a
              ...
              className="font-semibold text-brand-dark/90 hover:text-brand-primary transition-colors"
            >
              DigiBeloved
            </a>
          </p>
